...
<template>
  ...
  <main>
    <!-- 左侧导航 -->
   <div class="main-left">
    <el-menu default-active="/activeManage" class="el-menu-vertical-demo" :router="true">
    <el-menu-item index="/activeManage" :class="{'isActive': active}">活动发布</el-menu-item>
    <el-menu-item index="/activePublic" :class="{'isActive': !active}">活动管理</el-menu-item>
    </el-menu>
   </div>
    <!-- 右侧主内容区 -->
